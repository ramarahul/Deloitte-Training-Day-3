...
public class TestMain {
	...
	private static void generateEmployees() {
		...
		ArrayList<Department> depts  =generateDepartments();
		emps = new ArrayList<>();
		
		Employee e1 = new Employee("Emp1",1,10000,roles[0],depts.get(0),null);
		Employee e2 = new Employee("Emp2",2,10000,roles[0],depts.get(1),null);
		Employee e3 = new Employee("Emp3",3,10000,roles[1],depts.get(2),e2);
		Employee e4 = new Employee("Emp4",4,10000,roles[1],depts.get(3),e1);
		Employee e5 = new Employee("Emp5",5,10000,roles[2],depts.get(0),e2);
		Employee e6 = new Employee("Emp6",6,10000,roles[2],depts.get(1),e1);
	...
	private static ArrayList<Department> generateDepartments() {
		// TODO Auto-generated method stub
		ArrayList<Department> depts = new ArrayList<Department>();
		depts.add(new Department("Dept1","Hyderabad"));
		depts.add(new Department("Dept2","Bengaluru"));
		depts.add(new Department("Dept3","Chennai"));
		depts.add(new Department("Dept4","Mumbai"));
		return depts;
	}
